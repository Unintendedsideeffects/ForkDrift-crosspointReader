...
- **Status**: open — observed failing in roughly 2-3 of ~12 book opens; not yet instrumented to log the largest block immediately before the attempt, which would confirm the boundary hypothesis directly
