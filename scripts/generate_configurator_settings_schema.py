...
SCHEMA_MACROS = [
    ...
    "ENABLE_HAIKU_CLOCK=1",
    "ENABLE_INTEGRATIONS=1",
    "ENABLE_TODO_PLANNER=1",
    "ENABLE_TRMNL_SWITCH=1",
    "ENABLE_TERMINUS_SLEEP=1",
    "ENABLE_NOTES=1",
    "ENABLE_USER_FONTS=1",
    "ENABLE_WIFI_CLOCK=1",
]
...
def build_exporter() -> None:
    ...
    cmd = [
        ...
        *[f"-D{macro}" for macro in SCHEMA_MACROS],
        ...
        str(ROOT / "src/util/BookSettingsOverride.cpp"),
        str(ROOT / "lib/I18n/I18n.cpp"),
        str(ROOT / "lib/I18n/I18nStrings.cpp"),
        str(ROOT / "lib/Logging/Logging.cpp"),
        str(ROOT / "test/mock/FeatureModuleHooks.cpp"),
        str(ROOT / "src/SettingsSerializer.cpp"),
