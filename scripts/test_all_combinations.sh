...
FEATURES=("bookerly_fonts" "notosans_fonts" "opendyslexic_fonts" "lexenddeca_fonts" "bitter_fonts" "chareink_fonts" "image_sleep" "book_images" "markdown" "integrations" "koreader_sync" "calibre_sync" "opds" "books_tab_ui" "background_server" "background_server_on_charge" "background_server_always" "home_media_picker" "pokemon_wallpaper_plugin" "pokemon_party" "epub_support" "hyphenation" "xtc_support" "lyra_theme" "flow_theme" "ota_updates" "todo_planner" "notes" "anki_support" "dictionary_lookup" "text_selection" "annotations" "per_book_settings" "remote_control" "remote_keyboard_input" "ble_page_turner" "lua_plugins" "dark_mode" "visual_cover_picker" "web_wallpaper_plugin" "ble_wifi_provisioning" "user_fonts" "web_wifi_setup" "usb_mass_storage" "global_landscape" "wifi_clock" "roman_clock_sleep" "haiku_clock_sleep" "reading_stats" "minimal_theme" "focus_reading" "guide_dots")
TOTAL=$((2 ** ${#FEATURES[@]}))
FAILED=0
PASSED=0
