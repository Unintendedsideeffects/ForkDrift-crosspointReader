...
constexpr FeatureDescriptor kFeatureCatalog[] = {
    ...
    {"lexenddeca_fonts", "Lexend Deca Fonts", ENABLE_LEXENDDECA_FONTS != 0, nullptr, 0, nullptr, 0},
    {"bitter_fonts", "Bitter Fonts", ENABLE_BITTER_FONTS != 0, nullptr, 0, nullptr, 0},
    {"chareink_fonts", "Chare Ink Fonts", ENABLE_CHAREINK_FONTS != 0, nullptr, 0, nullptr, 0},
    ...
    {"minimal_theme", "Minimal Theme", ENABLE_MINIMAL_THEME != 0, kRequiresLyraThemeAll,
     sizeof(kRequiresLyraThemeAll) / sizeof(kRequiresLyraThemeAll[0]), nullptr, 0},
    {"flow_theme", "Flow Theme (disabled pending rework)", ENABLE_FLOW_THEME != 0, kRequiresLyraThemeAll,
     sizeof(kRequiresLyraThemeAll) / sizeof(kRequiresLyraThemeAll[0]), nullptr, 0},
