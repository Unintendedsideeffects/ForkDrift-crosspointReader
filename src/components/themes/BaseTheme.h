...
class BaseTheme {
 ...
 public:
  ...
  void drawBatteryRight(const GfxRenderer& renderer, Rect rect, bool showPercentage = true, int textY = -1) const;
  ...
  void drawStatusBar(GfxRenderer& renderer, const float bookProgress, const int currentPage, const int pageCount,
                     const std::string& title, bool isPageBookmarked = false) const;
