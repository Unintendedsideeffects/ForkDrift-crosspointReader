...
class CrossPointSettings {
 ...
 public:
  ...
  // Global UI orientation (whole-UI landscape mode). Independent of the reader's
  // `orientation`. Only consumed when ENABLE_GLOBAL_LANDSCAPE=1; inert otherwise.
  uint8_t uiOrientation = PORTRAIT;
  // Button layouts
