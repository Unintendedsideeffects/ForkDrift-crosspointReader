...
const WebRouteTableHandler::CoreRoute WebRouteTableHandler::kCore[] = {
    ...
    {"/upload", HTTP_POST, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleUploadPost>,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleUpload>},
    ...
    {"/api/opds/delete", HTTP_POST, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleDeleteOpdsServer>,
     nullptr},
    {"/api/opds/test", HTTP_POST, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleTestOpdsServer>, nullptr},
    {"/api/koreader/use-opds", HTTP_POST, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleKoreaderUseOpds>,
     nullptr},
    {"/api/book-progress", HTTP_GET, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleGetBookProgress>,
     nullptr},
    ...
    {"/api/sleep-cover/pin", HTTP_POST, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleSleepCoverPin>,
     nullptr},
    ...
    {"/api/wifi/delete", HTTP_POST, &WebRouteTableHandler::invoke<&CrossPointWebServer::handleDeleteWifiNetwork>,
     nullptr},
    {"/api/wifi/forget-all", HTTP_POST,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleForgetAllWifiNetworks>, nullptr},
    {"/api/maintenance/validate-sleep-images", HTTP_POST,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleMaintenanceValidateSleepImages>, nullptr},
    {"/api/maintenance/clear-cache", HTTP_POST,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleMaintenanceClearCache>, nullptr},
    {"/api/maintenance/reset-settings", HTTP_POST,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleMaintenanceResetSettings>, nullptr},
    {"/api/maintenance/clear-logs", HTTP_POST,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleMaintenanceClearLogs>, nullptr},
    {"/api/maintenance/clear-crashes", HTTP_POST,
     &WebRouteTableHandler::invoke<&CrossPointWebServer::handleMaintenanceClearCrashes>, nullptr},
};

const size_t WebRouteTableHandler::kCoreCount =
    sizeof(WebRouteTableHandler::kCore) / sizeof(WebRouteTableHandler::kCore[0]);
