...
class KeyboardEntryActivity : public Activity {
 public:
  ...
  explicit KeyboardEntryActivity(GfxRenderer& renderer, MappedInputManager& mappedInput, std::string title,
                                 std::string initialText, const size_t maxLength, const bool isPassword, const int)
      : KeyboardEntryActivity(renderer, mappedInput, std::move(title), std::move(initialText), maxLength, isPassword) {}
