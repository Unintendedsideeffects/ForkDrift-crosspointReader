...
constexpr HostSetting kSettings[] = {
    {"sleepScreen", "Sleep screen", "Display", "enum", 0, kSleepScreenOptions, kSleepScreenOptionCount, 0, 0, 0,
     nullptr, 0},
    {"sleepScreenSource", "Sleep source", "Display", "enum", 0, kSleepSourceOptions, 3, 0, 0, 0, "sleepScreen", 2},
    {"sleepScreenCoverMode", "Sleep cover mode", "Display", "enum", 0, kFitCropOptions, 2, 0, 0, 0, "sleepScreen", 2},
    {"sleepScreenCoverFilter", "Sleep cover filter", "Display", "enum", 0, kSleepFilterOptions, 3, 0, 0, 0,
     "sleepScreen", 2},
    {"sleepCycleMode", "Sleep cycle mode", "Display", "enum", 0, kCycleOptions, 2, 0, 0, 0, "sleepScreen", 2},
