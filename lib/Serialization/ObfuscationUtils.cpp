...
const uint8_t* getHwKey() {
  // Function-local static initialization is synchronized by the compiler's
  // guard variable. The previous hand-rolled `initialized` bool could be
  // preempted mid-write and hand another task a partially populated key.
