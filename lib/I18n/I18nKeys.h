...
// Order: English, Беларуская, Català, Valencià, Čeština, Dansk, Deutsch, Español, Suomi, Français, Magyar, Italiano
// Қазақша, Lietuvių, Nederlands, Polski, Português (Brasil), Română, Русский, Slovenščina, Svenska, Türkçe
// clang-format off
// Українська, Tiếng Việt
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {static_cast<uint8_t>(Language::EN), static_cast<uint8_t>(Language::BE), static_cast<uint8_t>(Language::CA), static_cast<uint8_t>(Language::CAV), static_cast<uint8_t>(Language::CZECH), static_cast<uint8_t>(Language::DA), static_cast<uint8_t>(Language::DE), static_cast<uint8_t>(Language::ES), static_cast<uint8_t>(Language::FI), static_cast<uint8_t>(Language::FRENCH), static_cast<uint8_t>(Language::HU), static_cast<uint8_t>(Language::IT), static_cast<uint8_t>(Language::KK), static_cast<uint8_t>(Language::LT), static_cast<uint8_t>(Language::NL), static_cast<uint8_t>(Language::PL), static_cast<uint8_t>(Language::PORTUGUESE), static_cast<uint8_t>(Language::RO), static_cast<uint8_t>(Language::RUSSIAN), static_cast<uint8_t>(Language::SI), static_cast<uint8_t>(Language::SV), static_cast<uint8_t>(Language::TR), static_cast<uint8_t>(Language::UK), static_cast<uint8_t>(Language::VI)};
// clang-format on
